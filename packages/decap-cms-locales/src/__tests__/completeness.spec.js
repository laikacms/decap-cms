...
const BASELINE_DRIFT = {
  bg: { missing: 44, extra: 4 },
  ca: { missing: 44, extra: 0 },
  cs: { missing: 28, extra: 0 },
  da: { missing: 31, extra: 0 },
  de: { missing: 34, extra: 0 },
  es: { missing: 78, extra: 0 },
  fa: { missing: 29, extra: 0 },
  fr: { missing: 38, extra: 0 },
  gr: { missing: 95, extra: 0 },
  he: { missing: 36, extra: 0 },
  hr: { missing: 17, extra: 0 },
  hu: { missing: 104, extra: 0 },
  it: { missing: 29, extra: 0 },
  ja: { missing: 38, extra: 0 },
  ko: { missing: 30, extra: 0 },
  lt: { missing: 54, extra: 0 },
  mk: { missing: 28, extra: 0 },
  nb_no: { missing: 78, extra: 0 },
  nl: { missing: 41, extra: 0 },
  nn_no: { missing: 78, extra: 0 },
  pl: { missing: 36, extra: 0 },
  pt: { missing: 36, extra: 0 },
  ro: { missing: 42, extra: 2 },
  ru: { missing: 28, extra: 0 },
  sl: { missing: 29, extra: 0 },
  sr_Cyrl: { missing: 17, extra: 0 },
  sv: { missing: 40, extra: 0 },
  th: { missing: 28, extra: 0 },
  tr: { missing: 34, extra: 0 },
  uk: { missing: 35, extra: 0 },
  vi: { missing: 69, extra: 0 },
  zh_Hans: { missing: 39, extra: 2 },
  zh_Hant: { missing: 55, extra: 0 },
};
