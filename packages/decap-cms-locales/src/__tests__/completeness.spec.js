...
const BASELINE_DRIFT = {
  bg: { missing: 43, extra: 4 },
  ca: { missing: 43, extra: 0 },
  cs: { missing: 27, extra: 0 },
  da: { missing: 30, extra: 0 },
  de: { missing: 33, extra: 0 },
  es: { missing: 77, extra: 0 },
  fa: { missing: 28, extra: 0 },
  fr: { missing: 37, extra: 0 },
  gr: { missing: 94, extra: 0 },
  he: { missing: 35, extra: 0 },
  hr: { missing: 16, extra: 0 },
  hu: { missing: 103, extra: 0 },
  it: { missing: 28, extra: 0 },
  ja: { missing: 37, extra: 0 },
  ko: { missing: 29, extra: 0 },
  lt: { missing: 53, extra: 0 },
  mk: { missing: 27, extra: 0 },
  nb_no: { missing: 77, extra: 0 },
  nl: { missing: 40, extra: 0 },
  nn_no: { missing: 77, extra: 0 },
  pl: { missing: 35, extra: 0 },
  pt: { missing: 35, extra: 0 },
  ro: { missing: 41, extra: 2 },
  ru: { missing: 27, extra: 0 },
  sl: { missing: 28, extra: 0 },
  sr_Cyrl: { missing: 16, extra: 0 },
  sv: { missing: 39, extra: 0 },
  th: { missing: 27, extra: 0 },
  tr: { missing: 33, extra: 0 },
  uk: { missing: 34, extra: 0 },
  vi: { missing: 68, extra: 0 },
  zh_Hans: { missing: 38, extra: 2 },
  zh_Hant: { missing: 54, extra: 0 },
};
