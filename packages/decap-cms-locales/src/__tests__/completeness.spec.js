...
const BASELINE_DRIFT = {
  bg: { missing: 48, extra: 4 },
  ca: { missing: 48, extra: 0 },
  cs: { missing: 32, extra: 0 },
  da: { missing: 35, extra: 0 },
  de: { missing: 38, extra: 0 },
  es: { missing: 82, extra: 0 },
  fa: { missing: 33, extra: 0 },
  fr: { missing: 42, extra: 0 },
  gr: { missing: 99, extra: 0 },
  he: { missing: 40, extra: 0 },
  hr: { missing: 21, extra: 0 },
  hu: { missing: 108, extra: 0 },
  it: { missing: 33, extra: 0 },
  ja: { missing: 42, extra: 0 },
  ko: { missing: 34, extra: 0 },
  lt: { missing: 58, extra: 0 },
  mk: { missing: 32, extra: 0 },
  nb_no: { missing: 82, extra: 0 },
  nl: { missing: 45, extra: 0 },
  nn_no: { missing: 82, extra: 0 },
  pl: { missing: 40, extra: 0 },
  ...
  th: { missing: 32, extra: 0 },
  tr: { missing: 38, extra: 0 },
  uk: { missing: 39, extra: 0 },
  vi: { missing: 73, extra: 0 },
  zh_Hans: { missing: 43, extra: 2 },
  zh_Hant: { missing: 59, extra: 0 },
};
