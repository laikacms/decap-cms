...
export function replaceWhen(
   ...
   * internally).
   */
  function split(exp: RegExp, text: string, acc: SubstringData[]): SubstringData[] {
    /**
   ...
   * array.
   */
  function addSubstring(arr: SubstringData[], index: number, text: string, match = false): void {
