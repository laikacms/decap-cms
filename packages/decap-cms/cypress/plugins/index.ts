...
import { setupBitBucket, setupBitBucketTest, teardownBitBucket, teardownBitBucketTest } from './bitbucket';
import { setupGitGateway, setupGitGatewayTest, teardownGitGateway, teardownGitGatewayTest } from './gitGateway';
import { seedGitHubRepo, setupGitHub, setupGitHubTest, teardownGitHub, teardownGitHubTest } from './github';
import { setupGitLab, setupGitLabTest, teardownGitLab, teardownGitLabTest } from './gitlab';
import { setupProxy, setupProxyTest, teardownProxy, teardownProxyTest } from './proxy';
