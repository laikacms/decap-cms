...
import { decapAi } from '@/ai/decap-ai';

import type { AiSession, AiSessionCallbacks, DecapAiConfig, User } from '@/ai/types';
import type * as AiSdk from 'ai';

// ---------------------------------------------------------------------------
// Mock the `ai` SDK so tests never touch a real model. `vi.mock` is hoisted
// above the imports, so `decapAi` sees the mocked module.
// ---------------------------------------------------------------------------
