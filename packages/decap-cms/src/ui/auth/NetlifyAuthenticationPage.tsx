...
import { AuthenticationPage, buttons, colors, colorsRaw, lengths, shadows, zIndex } from '@/ui/default/index';
...
NetlifyAuthenticationPage.authClient = (() => Promise.reject(new Error('authClient not configured'))) as () => Promise<
  AuthClient
>;
