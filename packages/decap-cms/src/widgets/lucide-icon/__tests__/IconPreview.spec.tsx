/**
 * Unit tests for the lucide-icon widget's IconPreview component (DCMS-1343).
 *
...
import { IconPreview } from '@/widgets/lucide-icon/IconPreview';

const KNOWN_ICON_NAME = Object.keys(lucideIcons)[0];

describe('IconPreview (lucide-icon)', () => {
