...
`widgets/lucide-icon` subpath export and register it themselves.
...
import WidgetIcon from '@laikacms/decap-cms/widgets/lucide-icon';
...
```ts
import WidgetIcon, { type IconWidgetOptions } from '@laikacms/decap-cms/widgets/lucide-icon';
