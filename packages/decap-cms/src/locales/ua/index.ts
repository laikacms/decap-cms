const ua = {
  ...
  editor: {
    ...
    editor: {
      ...
      onPublishingWithUnsavedChanges: 'У вас є незбережені зміни, будь ласка, збережіть їх перед публікацією.',
      ...
      onDeleteUnpublishedChanges: 'Всі неопубліковані зміни в цій записі будуть видалені. Ви все ще хочете видалити?',
      loadingEntry: 'Завантаження запису ...',
      confirmLoadBackup: 'Для цієї запису була відновлена локальна резервна копія, хочете використовувати її?',
    },
    editorToolbar: {
  ...
  mediaLibrary: {
    ...
    mediaLibrary: {
      ...
      fileTooLarge: 'Файл занадто великий.\nНалаштування не дозволяють зберігати файли більше %{size} MiB.',
    },
    mediaLibraryModal: {
  ...
  ui: {
    ...
    toast: {
      ...
      missingRequiredField: "На жаль, ви пропустили обов'язкове поле. Будь ласка, заповніть перед збереженням. |||| На жаль, ви пропустили обов'язкове поле. Будь ласка, заповніть перед збереженням.",
