const gr = {
  ...
  mediaLibrary: {
    ...
    mediaLibrary: {
      ...
      fileTooLarge: 'Το αρχείο είναι πολύ μεγάλο.\nΔεν επιτρέπονται αρχεία μεγαλύτερα από %{size} MiB.',
    },
    mediaLibraryModal: {
      loading: 'Φόρτωση...',
  ...
  ui: {
    ...
    toast: {
      ...
      missingRequiredField: 'Ουπς, ξεχάσατε ένα απαιτούμενο πεδίο. Συμπληρώστε το πριν από την αποθήκευση. |||| Ουπς, ξεχάσατε ένα απαιτούμενο πεδίο. Συμπληρώστε το πριν από την αποθήκευση.',
