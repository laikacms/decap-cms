const it = {
  ...
  editor: {
    ...
    editor: {
      ...
      onUpdatingWithUnsavedChanges: 'Hai delle modifiche non salvate, salvale prima di aggiornare lo stato.',
  ...
  ui: {
    ...
    toast: {
      ...
      onBackendDown: 'Il servizio di backend non è raggiungibile. Consulta %{details} per maggiori informazioni',
    },
  },
  workflow: {
    workflow: {
