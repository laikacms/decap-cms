const mk = {
  ...
  mediaLibrary: {
    ...
    mediaLibrary: {
      ...
      fileTooLarge: 'Датотеката е преголема.\nКонфигурацијата не дозволува датотеки поголеми од %{size} MiB.',
    },
    mediaLibraryModal: {
      loading: 'Се вчитува...',
  ...
  ui: {
    ...
    toast: {
      ...
      missingRequiredField: 'Пропуштивте задолжително поле. Ве молиме пополнете го пред да зачувате. |||| Пропуштивте задолжително поле. Ве молиме пополнете го пред да зачувате.',
