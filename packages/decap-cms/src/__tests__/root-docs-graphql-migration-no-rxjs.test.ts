...
// DCMS-1233: `breaking-changes-v4-beta.md`'s "GraphQL client libraries are
...
describe('rxjs is not part of the decap-cms GraphQL contract (DCMS-1233)', () => {
  it('is absent from packages/decap-cms/package.json dependency fields', () => {
    ...
    // genuinely needed now (in which case breaking-changes-v4-beta.md's
  ...
  it("is absent from breaking-changes-v4-beta.md's GraphQL migration `pnpm add` line", () => {
