...
An abstraction layer between the CMS and [Azure DevOps](https://learn.microsoft.com/en-us/rest/api/azure/devops/).
...
`AuthenticationPage.tsx` - A component that facilitates implicit OAuth authentication against
Azure AD.
