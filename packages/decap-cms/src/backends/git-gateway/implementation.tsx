...
import { API as BitBucketAPI, BitbucketBackend } from '@/backends/bitbucket/index';
    ...
    const api = await fetch(this.gitGatewayStatusEndpoint)
      ...
      .then(res => {
        return res['components']
          .filter((statusComponent: GitGatewayStatus) => GIT_GATEWAY_OPERATIONAL_UNITS.includes(statusComponent.name))
