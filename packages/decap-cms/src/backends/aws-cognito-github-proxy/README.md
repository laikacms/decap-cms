...
The token exchange request is sent as
`application/x-www-form-urlencoded; charset=utf-8`, and login requests the scope
`https://api.github.com/repo openid email`.
