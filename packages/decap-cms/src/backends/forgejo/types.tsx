...
// Editorial-workflow-only types (branches / pull requests / labels). Forgejo's
// REST API is Gitea-compatible; the plain Gitea backend in this repo does not
// support the editorial workflow so these shapes live here rather than in the
// shared types module.

export type ForgejoBranchCommit = {
  id: string,
  author?: { name?: string, email?: string, date?: string, username?: string },
  committer?: { name?: string, email?: string, date?: string, username?: string },
  message?: string,
  url?: string,
};
