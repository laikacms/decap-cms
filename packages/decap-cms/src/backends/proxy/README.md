...
A backend that delegates all git operations to an external HTTP proxy server instead of talking to a
git host (GitHub, GitLab, Bitbucket, ...) directly. Useful for local development against
