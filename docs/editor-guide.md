...
| Map       | An interactive map for drawing a single point, line, or polygon. Saved as GeoJSON.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |

Some sites also enable widgets built specifically for them. If you see a field that isn't in the
table above, it's a custom widget built for that site.
