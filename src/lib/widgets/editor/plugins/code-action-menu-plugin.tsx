...
import { useDebounce } from '@/lib/widgets/editor/editor-hooks/use-debounce';
import { CopyButton } from '@/lib/widgets/editor/editor-ui/code-button';
import { getCodeLanguageLabel } from '@/lib/widgets/editor/utils/code-languages';
...
function CodeActionMenuContainer({ anchorElem }: { anchorElem: HTMLElement }): JSX.Element {
  ...
  const codeFriendlyName = getCodeLanguageLabel(lang);
