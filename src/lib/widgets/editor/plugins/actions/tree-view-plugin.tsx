...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/lib/widgets/editor/ui/dialog';
import { ScrollArea, ScrollBar } from '@/lib/widgets/editor/ui/scroll-area';
