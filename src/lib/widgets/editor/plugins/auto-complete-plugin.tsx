...
import { $createAutocompleteNode, AutocompleteNode } from '@/lib/widgets/editor/nodes/autocomplete-node';
import { addSwipeRightListener } from '@/lib/widgets/editor/utils/swipe';
    ...
    const promise: Promise<null | string> = new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        const caseInsensitiveSearchText = isCapitalized
          ? String.fromCharCode(char0 + 32) + searchText.slice(1)
          : searchText;
        ...
        const matchCapitalized = isCapitalized
          ? String.fromCharCode(match.charCodeAt(0) - 32) + match.slice(1)
          : match;
        const autocompleteChunk = matchCapitalized.slice(searchTextLength);
