...
import {
  ...
  LayoutContainerNode,
} from '@/lib/widgets/editor/nodes/layout-container-node';
import { $createLayoutItemNode, $isLayoutItemNode, LayoutItemNode } from '@/lib/widgets/editor/nodes/layout-item-node';
import { Button } from '@/lib/widgets/editor/ui/button';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/lib/widgets/editor/ui/select';
...
export function InsertLayoutDialog({
  ...
  return (
    <>
      <Select onValueChange={setLayout} defaultValue={layout} items={LAYOUTS}>
