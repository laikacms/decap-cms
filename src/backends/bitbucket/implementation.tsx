...
export default class BitbucketBackend implements CmsImplementation {
  ...
  getRefreshedAccessToken() {
    ...
    this.refreshedTokenPromise = (
      ...
      this.updateUserCredentials({ token, refresh_token: refresh_token as string });
      return token;
    });
  ...
  async persistMedia(mediaFile: CmsAssetProxy, options: CmsPersistOptions) {
    ...
    return {
      ...(await this._persistMedia(persistMediaArgument as unknown as CmsAssetProxy, options)),
      displayURL,
    };
  }
