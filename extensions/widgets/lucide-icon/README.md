...
**`@laikacms/decap-cms-widget-lucide-icon` is not published to npm** (tracked in
...
cp -R extensions/widgets/lucide-icon path/to/your-project/vendor/decap-cms-widget-lucide-icon
```
...
{
  "dependencies": {
    "@laikacms/decap-cms-widget-lucide-icon": "workspace:*"
  }
}
```
